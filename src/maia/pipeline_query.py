...
def ingest_data_dir(data_dir: str | None = None) -> dict:
    data_dir = data_dir or settings.DATA_DIR
    embedder, store, retriever, _, _ = build_stack()
...
def query(question: str, top_k_final: int | None = None) -> dict:
    _, store, retriever, reranker, llm = build_stack()
